...
If Cells(i, 1).Value = Cells(i + 1, 1).Value And Cells(i, 2).Value = 20180102 Or Cells(i, 2).Value = 20190102 Or Cells(i, 2).Value = 20200102 Then
start1 = Cells(i, 3).Value
ElseIf Cells(i, 1).Value = Cells(i + 1, 1).Value And Cells(i + 1, 2).Value = 20181231 Or Cells(i + 1, 2).Value = 20191231 Or Cells(i + 1, 2).Value = 20201231 Then
...
For i = 2 To 759000
If Cells(i, 2) = 20180102 Or Cells(i, 2) = 20190102 Or Cells(i, 2) = 20200102 Then
